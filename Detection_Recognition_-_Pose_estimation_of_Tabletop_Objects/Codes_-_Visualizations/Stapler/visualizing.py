...
model.load_weights("tabletop_stapler_angle_detection.best.hdf5")
model.summary() 
...
for filter_index in range(filter_nos):
    ...
    im=cv2.imread('stapler_1_A2_H1_S1-LR_Masked.png',cv2.IMREAD_GRAYSCALE)
...
imsave('layer5_stapler_input%dx%d.png' % (n, n), stitched_filters)
