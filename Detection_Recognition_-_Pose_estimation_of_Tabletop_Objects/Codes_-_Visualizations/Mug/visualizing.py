...
model.load_weights("tabletop_mug_angle_detection.best.hdf5")
model.summary() 
...
for filter_index in range(filter_nos):
    ...
    im=cv2.imread('mug_1_A1_H1_S1-LR_Masked23.png',cv2.IMREAD_GRAYSCALE)
...
imsave('layer1_mug3_input%dx%d.png' % (n, n), stitched_filters)
